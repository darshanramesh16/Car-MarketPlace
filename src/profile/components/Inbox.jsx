...
function Inbox() {
 ...
 useEffect(() => {
  ...
  return (
    <div className="w-full h-[calc(100vh-80px)] bg-gradient-to-br from-white via-gray-50 to-gray-100 p-1 pt-10">
      <SendBirdProvider
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 h-140 w-full">
          {/* Channel List */}
