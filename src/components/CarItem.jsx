...
const imageUrl = car?.images?.length > 0
  ...
  return (
    ...
    <div className='rounded-xl bg-[#5d5c6471] border hover:shadow-md cursor-pointer relative'>
      <h2 className='absolute m-1 bg-gray-600 px-2 rounded-full text-sm pb-0.5 text-white'>New</h2>
      <img
        src={imageUrl}
      ...
      <div className='p-3'>
        ...
        <Separator className="mt-3 my-3 bg-black" />
        <div className='flex items-center justify-between'>
          <h2 className='font-bold text-lg'>${car?.sellingPrice}</h2>
          <h2 className='text-black text-md flex gap-2 items-center'>
