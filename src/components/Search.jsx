    ...
    return (
        <div className='relative p-2 md:p-2 bg-white rounded-md md:rounded-full flex-col md:flex md:flex-row gap-10 px-5 items-center w-[60%]'>
            ...
            <Select onValueChange={setCars}>
                <SelectTrigger className="outline-none md:border-none w-full shadow-none text-lg font-bold">
            ...
            <Separator orientation='vertical' className="hidden md:block bg-gray-500" />
